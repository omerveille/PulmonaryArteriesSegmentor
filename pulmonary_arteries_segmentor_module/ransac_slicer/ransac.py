...
def run_ransac(vol, starting_point, direction_point, starting_radius, pct_inlier_points,
    ...
    if isNewBranch:
        ...
        end_center_line, end_center_radius = graph_branches.updateGraph(idx_cb, idx_cyl, parent_node)
    else:
        parent_node = None
    ...
    graph_branches.createNewBranch((len(graph_branches.nodes) - 2, len(graph_branches.nodes) - 1), centers_line, contour_points, center_line_radius, parent_node)
